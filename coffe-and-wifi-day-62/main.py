...
class CafeForm(FlaskForm):
    ...
    location_url = StringField('Cafe location on Google Maps (URL)', [URL(), DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        print("True")
        with open(file='cafe-data.csv', encoding="utf8", mode='a') as csv_file:
            csv_file.write(f'\n{form.cafe.data},{form.location_url.data},{form.open_time.data},{form.close_time.data},'
